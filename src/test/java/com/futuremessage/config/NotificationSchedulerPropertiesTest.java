...
class NotificationSchedulerPropertiesTest {
    ...
    void rejectsNonPositiveInterval() {
        assertThatThrownBy(() -> new NotificationSchedulerProperties(true, Duration.ZERO, 50))
    ...
    void rejectsBatchSizeOutOfRange() {
        assertThatThrownBy(() -> new NotificationSchedulerProperties(true, Duration.ofSeconds(30), 0))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("batch-size");
        assertThatThrownBy(() -> new NotificationSchedulerProperties(true, Duration.ofSeconds(30), 501))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("batch-size");
    }
}
