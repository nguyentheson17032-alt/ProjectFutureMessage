...
import com.futuremessage.security.AuthRateLimitFilter;
import com.futuremessage.security.JwtAuthenticationFilter;
import com.futuremessage.security.RestAccessDeniedHandler;
import com.futuremessage.security.RestAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        if (!origins.isEmpty()) {
            // Patterns like http://localhost:[*] cover Vite on 5173 and 127.0.0.1.
            configuration.setAllowedOriginPatterns(origins);
        }
        configuration.setAllowedMethods(List.of("GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(List.of("*"));
        configuration.setExposedHeaders(List.of("Authorization"));
        // Bearer tokens in Authorization; the SPA does not send cookies.
